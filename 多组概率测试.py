...
# 画图
    ...
    print("slide:", sli_accuracy_acc/trial," slide:",sli_accuracy_acc/trial, flush=True)
    print("double:", dou_accuracy_acc/trial," slide:",double_regret_accumulation/trial, flush=True)
    print("slide:", sli_accuracy_acc/trial," slide:",slide_window_accumulation/trial, flush=True)
